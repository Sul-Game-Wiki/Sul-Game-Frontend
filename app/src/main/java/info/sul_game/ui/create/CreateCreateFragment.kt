...
class CreateCreateFragment : Fragment() {
    ...
    private lateinit var gameCreateAdapter: CreateCreateGameAdapter
    private lateinit var introCreateAdapter: CreateCreateGameAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gameCreateAdapter = CreateCreateGameAdapter(mutableListOf(),this)
        ...
        introCreateAdapter = CreateCreateGameAdapter(mutableListOf(),this)
